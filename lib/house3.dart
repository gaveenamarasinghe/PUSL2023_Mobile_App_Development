...
class House3 extends StatefulWidget {
  const House3({Key? key}) : super(key: key);

  @override
  State<House3> createState() => _House1State();
}

class _House1State extends State<House3> {
  @override
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            Image.asset(
              "images/h3.jpg", // Replace with your image path
              fit: BoxFit.cover,
